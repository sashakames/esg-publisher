...
echo "  4. Wait for conda-forge bot PR: https://github.com/conda-forge/esgcet-feedstock/pulls"
echo "     (regro-cf-autotick-bot will auto-create a PR within 24-48 hours)"
echo "  5. Review and merge the conda-forge bot PR"
